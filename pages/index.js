// pages/index.js — Single-page (company style) with mobile overlay menu + unified CTAs
    ...
    <>
      ...
      <header className={`site-header${open ? " is-open" : ""}`}>
        <nav className="nav" aria-label="Main navigation">
          ...
          {/* Login always visible on mobile */}
          ...
          {/* Desktop nav (anchors only since it's single page) */}
          <ul className="nav-links" role="list">
            ...
            <li className="nav-cta">
              <a className="btn btn-primary" href="#how">Get Verified</a>
            </li>
          </ul>
        </nav>
        ...
        {/* Mobile overlay menu */}
        {open && (
          <div className="mobile-menu" role="dialog" aria-modal="true" onClick={()=>setOpen(false)}>
            <div className="mobile-inner" onClick={(e)=>e.stopPropagation()}>
              ...
              <a href="#" className="menu-link" onClick={(e)=>{e.preventDefault(); setOpen(false); fakeLogin(e);}}>Login</a>
              <a href="#how" className="btn btn-primary menu-cta" onClick={()=>setOpen(false)}>Get Verified</a>
            </div>
          </div>
        )}
      </header>
...
- returns: { txid }`}
        ...
        <section id="support" className="container section">
          ...
          <div className="support-grid">
            ...
            <form onSubmit={onSupportSubmit} className="card" style={{background:"linear-gradient(135deg, rgba(37,99,235,.12), rgba(56,189,248,.12))"}}>
      ...
      <style jsx global>{`
        ...
        *{box-sizing:border-box}
        ...
        .site-header.is-open{position:sticky}
        ...
        .login-mobile{display:none;margin-left:auto;margin-right:8px}
