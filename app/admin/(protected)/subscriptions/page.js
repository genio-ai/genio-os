  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <main style={{ flex: 1, padding: 24 }}>
        <h1 style={{ margin: 0, marginBottom: 12 }}>Subscriptions</h1>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ background: "#fafafa" }}>
                ...
                <th style={{ textAlign: "left", padding: 12, borderBottom: "1px solid #eee" }}>Plan</th>
                <th style={{ textAlign: "left", padding: 12, borderBottom: "1px solid #eee" }}>Status</th>
                <th style={{ textAlign: "left", padding: 12, borderBottom: "1px solid #eee" }}>Renews</th>
              </tr>
            </thead>
            <tbody>
              <tr>
