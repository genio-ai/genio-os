...
// نص قصير ومتوافق مع سياسة PayPal يظهر قرب زر التبرع
const DONATION_DESCRIPTION = (
  <>
    <p dir="rtl" className="introText" style={{ marginTop: 8 }}>
      بعد إتمام التبرع، سنرسل لك <strong>دليلًا بالصور أو الفيديو</strong> يثبت
      وصول المساعدة للمستفيدين، التزامًا بالشفافية والمصداقية.
    </p>
    <p className="introText" style={{ marginTop: 4 }}>
      After you donate, we will share <strong>photo/video proof</strong> showing
      delivery to beneficiaries for full transparency.
    </p>
  </>
);
      ...
      <main className="stack">
        ...
        <section className="section">
          <div className="card" style={{ padding: 16 }}>
            ...
            {/* وصف شفاف قريب من الزر (بدون تغيير التصميم) */}
