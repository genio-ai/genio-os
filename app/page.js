...
/**
 * /app/page.js (final client-only)
 * - Force dynamic rendering to avoid Next.js pre-render errors
 * - Offers UI, modal form, localStorage fallback
 * - English default; Arabic toggled after pressing language button
 */
