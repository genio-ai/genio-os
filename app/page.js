  ...
  return (
    <div className="page">
      ...
      <section className="about card">
        ...
        <p className="aboutLead" dir="rtl"><strong>نحن وسطاء مستقلّون</strong> نتعاون مع جمعيات خيرية مرخّصة لتوصيل المساعدات بشفافية كاملة.</p>
      ...
      {/* ===== Global Styles (UNRWA darker sky + unified +/−) ===== */}
      <style jsx global>{`
        :root{
        ...
        *{ box-sizing:border-box }
        ...
        .aboutTitle{ margin:0 0 10px; color: var(--unrwa); }
        .aboutLead{ margin:0 0 8px; font-size:16px; }
        .aboutText{ margin:0 0 6px; color:#2B4563; line-height:1.55; }
