    ...
    <div className="page">
      ...
      {subtotal>0 && (
        <div className="sticky" role="region" aria-label="Donation summary">
          ...
          <button className="btnPrimary" onClick={()=>setPayOpen(true)}>Donate now • تبرّع الآن</button>
        </div>
      )}
      ...
      {/* ===== Styles ===== */}
      <style jsx global>{`
        :root{ --bg:#CFE5FA; --unrwa:#0072CE; --unrwa-dark:#003366; --line:#C5D9EF; }
        *{ box-sizing:border-box }
        ...
        .pill{
          ...
          font-weight:900; font-size:22px; line-height:1; background:#0072CE; color:#fff; border:1px solid #005BB0;
