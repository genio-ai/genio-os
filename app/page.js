...
const sx = {
  ...
  infoBar:{display:"flex",justifyContent:"space-around",gap:12,padding:"10px 12px",background:"linear-gradient(180deg, rgba(0,90,140,.15), rgba(0,90,140,.10))",
    borderTop:"1px solid rgba(54,212,255,.35)",borderBottom:"1px solid rgba(54,212,255,.35)",fontSize:14},
  desk:{display:"flex",flexWrap:"wrap",gap:28,padding:"24px 18px 72px",justifyContent:"center"}, left:{flex:"1 1 380px",maxWidth:620}, right:{flex:"1 1 320px",maxWidth:420},
