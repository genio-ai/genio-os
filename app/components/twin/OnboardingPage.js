...
/* --------------------------------
 * Safe ObjectURL hook (prevents client crash)
 * -------------------------------- */
        ...
        <ReviewStep
          ...
          onSubmit={async () => {
            try {
              ...
              // <-- جلب userId من Supabase بشكل آمن (بدون مشاكل مسارات)
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="flex justify-end">
        <button
          className="px-4 py-2 rounded bg-gray-200 text
